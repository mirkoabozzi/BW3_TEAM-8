                  ...
                  return (
                    <Card key={post._id} className="my-2">
                      ...
                      <Card.Body>
                        ...
                        <Card.Text className="border-bottom pb-4" style={{ fontSize: "13px" }}>Ultima modifica {dataConverter(post.updatedAt)}</Card.Text>


                        <div className="d-flex" style={{ justifyContent: "space-around", cursor: "pointer" }}>
                          <div className="d-flex align-items-center">
                            <div className="me-1" style={{ fontWeight: "500" }}>Consiglia</div>
                          ...
                          <div className="d-flex align-items-center">
                            <div className="me-1" style={{ fontWeight: "500" }}>Commenta</div>
                          ...
                          <div className="d-flex align-items-center">
                            <div className="me-1" style={{ fontWeight: "500" }}>Condividi</div>
      ...
      <Modal centered show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          <Form onSubmit={handleSubmitEditPost}>
            ...
            <Button className="rounded-pill" style={{ backgroundColor: "#0A66C2" }} type="submit">Invia</Button>
          </Form>
        </Modal.Body>
      </Modal>
    </>
