  ...
  return (
    <Container>
      ...
      <Container className="position-relative">
       ...
       <Card>
       <Card.Text className="ps-2 pt-2" as="div"><strong>Altri profili simili</strong></Card.Text>

            <Container className="d-flex flex-column">
              <Card.Body className="d-flex align-items-center">
                <Image src="https://img.redbull.com/images/c_crop,x_1866,y_0,h_1866,w_2134/c_fill,w_300,h_300/q_auto:low,f_auto/redbullcom/2023/11/16/leaff7lqiomqi59y8dnm/christian-horner-oracle-red-bull-racing-garage" roundedCircle width="40" height="40" className="me-3"/>
                <div>
              ...
              <Card.Body className="d-flex align-items-center">
                <Image src="https://images.everyeye.it/img-notizie/il-paradosso-andrea-stella-ex-ferrari-rinascere-mclaren-v3-659274-1280x960.webp" roundedCircle width="40" height="40" className="me-3"/>
                <div>
              ...
              <Card.Body className="d-flex align-items-center">
                <Image src="https://upload.wikimedia.org/wikipedia/commons/9/92/MJXKPW_240117_SF_F1_FVasseur_Red_PR_AN_076161-1920x0_YRHUGH_%28cropped%29.jpg" roundedCircle width="40" height="40" className="me-3"/>
                <div>
              ...
              <Card.Body className="d-flex align-items-center">
                <Image src="https://media.licdn.com/dms/image/C4E05AQGFiHL0_gOIqQ/feedshare-thumbnail_720_1280/0/1676050677954?e=2147483647&v=beta&t=1NXJZeJhBkZTTfISMSg3UwVduVB1SmvUmgINPqz7mx4" roundedCircle width="40" height="40" className="me-3"/>
                <div>
              ...
              <Card.Body className="d-flex align-items-center">
                <Image src="https://img.redbull.com/images/c_fill,g_auto,w_450,h_450/q_auto:low,f_auto/redbullcom/2013/11/26/1331621993877_2/f1-adrian-newey-red-bull-racing-rb5" roundedCircle width="40" height="40" className="me-3"/>
                <div>
