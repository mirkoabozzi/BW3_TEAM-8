        ...
        <Card className=" text-start p-0" id="messages">
          <div className="d-flex justify-content-between align-items-center">
            <div className="d-flex align-items-center">
              ...
              <div style={{ fontSize: "17px", fontWeight: "600" }} className="ms-3">
                Messaggistica
              </div>
            </div>
          ...
          {expanded && (
            <div className="message-content mt-2">
              {[...profilesAside].slice(379, 385).map((profile) => (
                <div key={profile._id} className="profile-item">
                  <div className="d-flex my-4 align-items-center">
                    ...
                    <div className="d-flex flex-column">
                      ...
                      <div className="message-text border-bottom pb-2" style={{ fontSize: "14px" }}>
                        {profile.bio}
                      </div>
                    </div>
                  </div>
