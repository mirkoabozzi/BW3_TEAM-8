import { Button, Container, Form, Image, Navbar, NavDropdown } from "react-bootstrap";
        ...
        <div className="d-flex flex-column align-items-center">
          ...
          <NavDropdown title="Tu" id="navbarScrollingDropdown" drop="down" align="end">
            <div className="d-flex">
              <div>
                <Image className="rounded-circle" fluid src="https://www.tenforums.com/attachments/user-accounts-family-safety/322690d1615743307-user-account-image-log-user.png" alt="Profile image" />
              </div>
              <div>
            ...
            <Button variant="white border rounded-pill">Viusalizza Profilo</Button>
            <NavDropdown.Item href="#action3" className="fw-bold">
              Account
            </NavDropdown.Item>
            ...
            <NavDropdown.Item href="#action5">Post e Atttività</NavDropdown.Item>
            <NavDropdown.Divider />
