import { Button, Container, Form, Image, InputGroup, Navbar, NavDropdown } from "react-bootstrap";
import { Search } from "react-bootstrap-icons";

const MyNavbar = () => {
  return (
    <Navbar expand="lg" className="bg-body-white border border-bottom" height={30}>
      <Container fluid className="d-flex align-items-center justify-content-center">
        <div className="d-flex align-items-center me-5">
          ...
          <div className="mx-3">
            <InputGroup >
              <InputGroup.Text id="basic-addon1" className="border-0" style={{ backgroundColor: "#EDF3F8" }}>
                <Search />
              </InputGroup.Text>
              <Form.Control
                className="border-0"
                ...
                style={{ borderLeft: 0, backgroundColor: "#EDF3F8" }}
              />
            </InputGroup>
          </div>
        </div>
        ...
        <div className="d-flex align-items-center justify-content-center flex-wrap icon-nav">
          ...
          <div className="d-flex flex-column align-items-center mx-5">
            ...
            <NavDropdown title="Tu" id="navbarScrollingDropdown" drop="down" align="end">
              ...
              <Button variant="white border rounded-pill">Visualizza Profilo</Button>
              <NavDropdown.Item href="#action3" className="fw-bold">
                Account
              </NavDropdown.Item>
