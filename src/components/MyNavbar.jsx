  ...
  return (
    <Navbar expand="lg" className="bg-body-tertiary">
      <Container fluid>
        ...
        <div className="d-flex flex-column align-items-center">
          <div>
            <Image fluid src="https://www.tenforums.com/attachments/user-accounts-family-safety/322690d1615743307-user-account-image-log-user.png" alt="Profile image" width={40} />
          </div>
