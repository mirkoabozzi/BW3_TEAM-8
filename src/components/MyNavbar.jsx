    ...
    <Navbar expand="lg" className="bg-body-white border-bottom p-0" style={{ backgroundColor: "white" }}>
      <Container>
        ...
        <div className="d-flex align-items-center justify-content-center icon-nav">
          ...
          <Form className="ms-auto position-relative">
            ...
            {profiles.length > 0 && query.trim() !== "" && (
              <ListGroup className="position-absolute" style={{ zIndex: 1000, width: "100%" }}>
                {profiles.map((result) => (
                  <ListGroup.Item key={result._id} action onClick={() => handleProfileSelect({ ...result, type: "profile" })} className="list-group-item list-group-item-action">
          ...
          <div className="d-flex flex-column align-items-center mx-5 mt-2 icon-nav">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="#666666" className="mercado-match icon-nav" width="24" height="24" focusable="false">
              <path d="M16 4H8a7 7 0 000 14h4v4l8.16-5.39A6.78 6.78 0 0023 11a7 7 0 00-7-7zm-8 8.25A1.25 1.25 0 119.25 11 1.25 1.25 0 018 12.25zm4 0A1.25 1.25 0 1113.25 11 1.25 1.25 0112 12.25zm4 0A1.25 1.25 0 1117.25 11 1.25 1.25 0116 12.25z"></path>
            </svg>
              ...
              <NavDropdown title="Tu" id="navbarScrollingDropdown" drop="down" align="end" className="nav-dropdown-profile">
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <NavDropdown.Item href="#action3" style={{ fontSize: "14px" }}>
                      {user.title}
                    </NavDropdown.Item>
                  </div>
                </div>
